...
class MessengerServiceProvider extends ServiceProvider
{
    ...
    protected function offerPublishing()
    {
        if ($this->app->runningInConsole()) {
            $this->publishes([
                base_path('packages/cmgmyr/messenger/config/config.php') => config_path('messenger.php'),
            ], 'config');

            $this->publishes([
                base_path('packages/cmgmyr/messenger/migrations') => base_path('database/migrations'),
            ], 'migrations');
        }
    }
